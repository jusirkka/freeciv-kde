...
void setup_gui_funcs()
{
  ...
  funcs->gui_load_theme = Themes::LoadTheme;
  funcs->gui_clear_theme = Themes::ClearTheme;
  funcs->get_gui_specific_themes_directories = Themes::GetPaths;
  funcs->get_useable_themes_in_directory = Themes::GetThemes;
}

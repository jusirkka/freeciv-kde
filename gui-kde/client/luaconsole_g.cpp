...
void luaconsole_dialog_popup(bool raise) {
  qCDebug(FC) << "TODO: luaconsole_dialog_popup";
}

bool luaconsole_dialog_is_open() {
  qCDebug(FC) << "TODO: luaconsole_dialog_is_open";
  return false;
}

void real_luaconsole_dialog_update() {
  qCDebug(FC) << "TODO: real_luaconsole_dialog_update";
}

void real_luaconsole_append(const char *astring, const struct text_tag_list *tags) {
  qCDebug(FC) << "TODO: real_luaconsole_append";
}
